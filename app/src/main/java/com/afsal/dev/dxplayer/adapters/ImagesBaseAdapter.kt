...
class ImagesBaseAdapter(context: Context, private val listener: OnItemClickListner) :
    RecyclerView.Adapter<ImagesBaseAdapter.BaseItemHolder>() {

    //  private val diffCallbacks2= object :DiffUtil.ItemCallback<>

    val timeList = listOf("6 Jan", "4 Mar", "23 May", "17 Jul")

    class BaseItemHolder(val binding: ImageCardBaseItemBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        return BaseItemHolder(
            ImageCardBaseItemBinding.inflate(
